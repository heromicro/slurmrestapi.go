...
// checks if the V0043StatsUser type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &V0043StatsUser{}
...
func (o V0043StatsUser) ToMap() (map[string]interface{}, error) {
