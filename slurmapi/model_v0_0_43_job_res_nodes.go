...
// checks if the V0043JobResNodes type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &V0043JobResNodes{}
...
func (o V0043JobResNodes) ToMap() (map[string]interface{}, error) {
