...
// checks if the V0043Account type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &V0043Account{}
...
type _V0043Account V0043Account
...
func (o V0043Account) ToMap() (map[string]interface{}, error) {
...
func (o *V0043Account) UnmarshalJSON(data []byte) (err error) {
	...
	varV0043Account := _V0043Account{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varV0043Account)

	if err != nil {
		return err
	}

	*o = V0043Account(varV0043Account)
