...
// checks if the V0043License type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &V0043License{}
...
func (o V0043License) ToMap() (map[string]interface{}, error) {
