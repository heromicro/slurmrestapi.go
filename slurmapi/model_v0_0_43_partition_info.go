...
// checks if the V0043PartitionInfo type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &V0043PartitionInfo{}
...
func (o V0043PartitionInfo) ToMap() (map[string]interface{}, error) {
