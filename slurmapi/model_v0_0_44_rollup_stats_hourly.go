...
// checks if the V0044RollupStatsHourly type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &V0044RollupStatsHourly{}

// V0044RollupStatsHourly struct for V0044RollupStatsHourly
type V0044RollupStatsHourly struct {
...
func (o V0044RollupStatsHourly) MarshalJSON() ([]byte, error) {
...
func (o V0044RollupStatsHourly) ToMap() (map[string]interface{}, error) {
...
type NullableV0044RollupStatsHourly struct {
	value *V0044RollupStatsHourly
	isSet bool
}

func (v NullableV0044RollupStatsHourly) Get() *V0044RollupStatsHourly {
	return v.value
}

func (v *NullableV0044RollupStatsHourly) Set(val *V0044RollupStatsHourly) {
	v.value = val
	v.isSet = true
}

func (v NullableV0044RollupStatsHourly) IsSet() bool {
	return v.isSet
}

func (v *NullableV0044RollupStatsHourly) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableV0044RollupStatsHourly(val *V0044RollupStatsHourly) *NullableV0044RollupStatsHourly {
	return &NullableV0044RollupStatsHourly{value: val, isSet: true}
}

func (v NullableV0044RollupStatsHourly) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableV0044RollupStatsHourly) UnmarshalJSON(src []byte) error {
	v.isSet = true
