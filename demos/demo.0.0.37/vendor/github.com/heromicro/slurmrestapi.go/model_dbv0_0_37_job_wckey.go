...
// checks if the Dbv0037JobWckey type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &Dbv0037JobWckey{}
...
func (o Dbv0037JobWckey) ToMap() (map[string]interface{}, error) {
