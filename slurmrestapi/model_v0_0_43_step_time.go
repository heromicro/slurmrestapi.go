...
// checks if the V0043StepTime type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &V0043StepTime{}
...
func (o V0043StepTime) ToMap() (map[string]interface{}, error) {
