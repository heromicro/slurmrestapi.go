...
// checks if the V0044StatsRec type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &V0044StatsRec{}

// V0044StatsRec struct for V0044StatsRec
type V0044StatsRec struct {
	...
	RPCs []V0044StatsRpc `json:"RPCs,omitempty"`
	Users []V0044StatsUser `json:"users,omitempty"`
}
...
// SetRollups gets a reference to the given V0044RollupStats and assigns it to the Rollups field.
...
// SetRPCs gets a reference to the given []V0044StatsRpc and assigns it to the RPCs field.
...
// SetUsers gets a reference to the given []V0044StatsUser and assigns it to the Users field.
func (o *V0044StatsRec) SetUsers(v []V0044StatsUser) {
	o.Users = v
}

func (o V0044StatsRec) MarshalJSON() ([]byte, error) {
...
func (o V0044StatsRec) ToMap() (map[string]interface{}, error) {
...
type NullableV0044StatsRec struct {
	value *V0044StatsRec
	isSet bool
}

func (v NullableV0044StatsRec) Get() *V0044StatsRec {
	return v.value
}

func (v *NullableV0044StatsRec) Set(val *V0044StatsRec) {
	v.value = val
	v.isSet = true
}

func (v NullableV0044StatsRec) IsSet() bool {
	return v.isSet
}

func (v *NullableV0044StatsRec) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableV0044StatsRec(val *V0044StatsRec) *NullableV0044StatsRec {
	return &NullableV0044StatsRec{value: val, isSet: true}
}

func (v NullableV0044StatsRec) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableV0044StatsRec) UnmarshalJSON(src []byte) error {
	v.isSet = true
