...
// checks if the V0043Assoc type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &V0043Assoc{}
...
func (o V0043Assoc) ToMap() (map[string]interface{}, error) {
...
func (o *V0043Assoc) UnmarshalJSON(data []byte) (err error) {
	...
	varV0043Assoc := _V0043Assoc{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varV0043Assoc)

	if err != nil {
		return err
	}

	*o = V0043Assoc(varV0043Assoc)
