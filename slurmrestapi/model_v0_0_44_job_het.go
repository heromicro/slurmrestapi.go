...
// checks if the V0044JobHet type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &V0044JobHet{}

// V0044JobHet struct for V0044JobHet
type V0044JobHet struct {
...
// SetJobOffset gets a reference to the given V0044Uint32NoValStruct and assigns it to the JobOffset field.
func (o *V0044JobHet) SetJobOffset(v V0044Uint32NoValStruct) {
	o.JobOffset = &v
}

func (o V0044JobHet) MarshalJSON() ([]byte, error) {
...
func (o V0044JobHet) ToMap() (map[string]interface{}, error) {
...
type NullableV0044JobHet struct {
	value *V0044JobHet
	isSet bool
}

func (v NullableV0044JobHet) Get() *V0044JobHet {
	return v.value
}

func (v *NullableV0044JobHet) Set(val *V0044JobHet) {
	v.value = val
	v.isSet = true
}

func (v NullableV0044JobHet) IsSet() bool {
	return v.isSet
}

func (v *NullableV0044JobHet) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableV0044JobHet(val *V0044JobHet) *NullableV0044JobHet {
	return &NullableV0044JobHet{value: val, isSet: true}
}

func (v NullableV0044JobHet) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableV0044JobHet) UnmarshalJSON(src []byte) error {
	v.isSet = true
