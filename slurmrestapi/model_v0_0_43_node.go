...
// checks if the V0043Node type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &V0043Node{}
...
func (o V0043Node) ToMap() (map[string]interface{}, error) {
