...
// checks if the Dbv0037JobComment type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &Dbv0037JobComment{}
...
func (o Dbv0037JobComment) ToMap() (map[string]interface{}, error) {
