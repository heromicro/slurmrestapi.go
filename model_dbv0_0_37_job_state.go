...
// checks if the Dbv0037JobState type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &Dbv0037JobState{}
...
func (o Dbv0037JobState) ToMap() (map[string]interface{}, error) {
